...
@Test
@DisplayName("Subir imagen y recuperar informacion")
void uploadImage_GetInfo() {
...
@Test
@DisplayName("Obtener imagenes de un paciente")
void getImagenesPaciente() {
