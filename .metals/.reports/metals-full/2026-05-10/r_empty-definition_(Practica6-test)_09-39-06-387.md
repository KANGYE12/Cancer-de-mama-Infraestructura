error id: file:///C:/Users/Usuario/Documents/UNIVERSIDAD/INFRAESTRUCTURA/BLOQUE02/Practica6Alumnos/src/test/java/com/uma/example/springuma/integration/PacienteControllerMockMvcIT.java:org/springframework/test/web/servlet/ResultActions#andExpect().
...
found definition using semanticdb; symbol org/springframework/test/web/servlet/ResultActions#andExpect().
...
@Test
    ...
    void deletePaciente_YaNoExiste() throws Exception {
        ...
        String contenido = result.getResponse().getContentAsString();
        long idReal = JsonPath.read(contenido, "$.id");
